...
class Services(models.Model):
    sl_no = models.CharField(verbose_name="Service No.")
    ...
    service_image_alt_text = models.CharField(verbose_name="Service Image Alt Text")
...
class Slider(models.Model):
    ...
    slider_image_alt_text = models.CharField(verbose_name="Slider Image Alt Text")
